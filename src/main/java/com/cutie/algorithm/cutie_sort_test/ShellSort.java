...
public class ShellSort {
	public static void sort(int[] data) {
		for (int startInc = data.length/2; startInc!=0; startInc/=2) {
			for (int j = 0; j < startInc; j++) {
				insertSort(data, j, startInc);
			}
		}
	}
	...
	private static void insertSort(int[] data, int start, int inc) {
		for (int i = start; i < data.length-inc; i+=inc) {
			for (int j = i; j >= 0 ; j-=inc) {
